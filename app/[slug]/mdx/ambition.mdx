...
#### as second-generation immigrants, its easy to become spoiled by privilege and forget the sacrifices of our parents. 

eng4ui project.

#

<audio controls className="w-full color-lightBeige opacity-95">
  <source src="../../../notes/ambition/podcast.mp3" type="audio/mpeg"/>
