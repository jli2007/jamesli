...
export const places: PlacesType[] = [
  ...
  },
  {
    ...
    country: "portugal",
    flag: "🇵🇹",
    description: "villages deeply nestled in the mountainside — rural portugal.",
    tags: [
      { color: "dodgerblue", text: "● streetview" },
  ...
  },
  {
    ...
    flag: "🇨🇱",
    description:
      "a sudden shift between arid desert to the towering andes peaks.",
    tags: [
      { color: "mediumseagreen", text: "● world wonder" },
      { color: "orchid", text: "● south america" },
    ],
  ...
  },
  {
    ...
    country: "turkey",
    flag: "🇹🇷",
    description: "narrow road on lake — rural turkey.",
    tags: [
      { color: "dodgerblue", text: "● streetview" },
  ...
  },
  {
    ...
    flag: "🇮🇩",
    description:
      "misty villages in the shadow of mount merbabu.",
    tags: [
      { color: "dodgerblue", text: "● streetview" },
      { color: "red", text: "● asia" },
    ],
  ...
  },
  {
    ...
    country: "canada",
    flag: "🇨🇦",
    description: "quaint village in newfoundland — a world apart from industrial cities.",
    tags: [
      { color: "dodgerblue", text: "● streetview" },
  ...
  },
  {
    ...
    flag: "🇮🇹",
    description:
      "lush valleys — picturesque northern italy.",
    tags: [
      { color: "dodgerblue", text: "● streetview" },
      { color: "darksalmon", text: "● europe" },
    ],
  ...
  },
  {
    ...
    flag: "🇦🇷",
    description:
      "villages on andes' foothills — how long will these remote villages last?",
    tags: [
      { color: "dodgerblue", text: "● streetview" },
      { color: "orchid", text: "● south america" },
    ],
  ...
  },
  {
    ...
    flag: "🇪🇬",
    description:
      "the nile delta area — vibrant in greenery, unlike most of egypt. mo salah grew up in this region.",
    tags: [
  ...
  },
  {
    ...
    flag: "🇴🇲",
    description:
      "evocative of an island like madeira or las palmas — but this is oman.",
    tags: [
      { color: "dodgerblue", text: "● streetview" },
      { color: "darkgoldenrod", text: "● middle east" },
    ],
  ...
  {
    title: "buddha carvings",
    country: "china",
    flag: "🇨🇳",
    description:
      "henan province — 'longmen grottoes' date back to the 5th century.",
    tags: [
      { color: "mediumseagreen", text: "● world wonder" },
      { color: "red", text: "● asia" },
    ],
  ...
  },
  {
    ...
    flag: "🇯🇪",
    description:
      "northern edge of northern ireland — overlooking north atlantic.",
    tags: [
      { color: "dodgerblue", text: "● streetview" },
      { color: "darksalmon", text: "● europe" },
    ],
  ...
  },
  {
    ...
    flag: "🇨🇳",
    description:
      "rolling grasslands beneath vast blue skies — inner mongolia.",
    tags: [
      { color: "mediumvioletred", text: "● photosphere" },
      { color: "red", text: "● asia" },
    ],
  ...
  },
  {
    ...
    flag: "🇧🇷",
    description:
      "a clash between the grand atlantic, sand dunes, and the amazon rainforest.",
    tags: [
  ...
  },
  {
    ...
    flag: "🇹🇭",
    description:
      "historic district — northern thailand.",
    tags: [
      { color: "dodgerblue", text: "● streetview" },
      { color: "red", text: "● asia" },
    ],
  ...
  },
  {
    ...
    flag: "🇳🇴",
    description:
      "a lonely house by the shore — lofoten archipelago.",
    tags: [
      { color: "dodgerblue", text: "● streetview" },
      { color: "darksalmon", text: "● europe" },
    ],
