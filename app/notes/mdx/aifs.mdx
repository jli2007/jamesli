...
<h5>main takeaways: the selection for uw programs feel extremely random and depend very heavily on the reputation of the high school you attend (all the responses listed are from my school—one of the top feeder schools for uw). many friends who have submitted lesser polished aifs have gotten accepted during earlier rounds than those who spent months planning and writing it. my best advice is to focus more on answering the question with a simple direct tone rather than trying to tell a story with creative writing.</h5>
